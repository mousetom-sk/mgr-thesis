...
from nesyrl.envs.physical.reach import NicoReach
...
gym.register(id="nesyrl-physical/NicoReach-v0", entry_point=NicoReach)
...
if __name__ == "__main__":
    ...
    # Prepare environment
    test_env = gym.make("nesyrl-physical/NicoReach-v0", **env_kwargs)
