...
gym.register(id="nesyrl-physical/NedBlocksWorldMove-v0", entry_point=NedBlocksWorldMove)
...
if __name__ == "__main__":
    ...
    # Prepare environment
    test_env = gym.make("nesyrl-physical/NedBlocksWorldMove-v0", **env_kwargs)
