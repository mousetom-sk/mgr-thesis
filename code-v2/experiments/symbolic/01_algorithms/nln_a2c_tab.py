...
from nesyrl.agents.symbolic import Actor, CriticTab, ActorCriticOptimizer, A2CPolicy
from nesyrl.logic.neural import ConstantInitializer, UniformInitializer, NLAndProd, NLAndLuka, NLAndBiProd, NLAndBiLuka
...
log_dir = f"results/symbolic/01_algorithms/nln_a2c_tab_{time.strftime('%d%m%Y_%H%M%S', time.gmtime(time.time()))}"
